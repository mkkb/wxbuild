...
from vispy import gloo, glsl
from vispy.app import _default_app as default_app_module
from vispy.color import Color, ColorArray, get_colormap
from vispy.visuals.shaders import Function
from vispy.visuals.visual import Visual, CompoundVisual
...
class _GLLineVisual(Visual):
    ...
    def _prepare_draw(self, view):
        ...
        if default_app_module.default_app is None:
